...
(function() {
    ...
    baidu.object.extend(LuShu.prototype, {
         ...
         * @return 无返回值.
         */
        _moveNext: function(index,callBack) {
            var me = this;
            // 因为_moveNext会在_move里面递归调用，而_move执行时没有传callBack，会把值覆盖为undefined，所以判断一下，第一次传值未被覆盖时将其保存到me的自定义属性中
            if(callBack){
